...
insert into typeAnalyse (id, groupeSanguin, hemogramme, prix, vitesseSedimentation, duree) values (0, "A",  "hemogramme A",  10.0, 21, 2);
insert into typeAnalyse (id, groupeSanguin, hemogramme, prix, vitesseSedimentation, duree) values (1, "B",  "hemogramme B",  10.0, 21, 2);
insert into typeAnalyse (id, groupeSanguin, hemogramme, prix, vitesseSedimentation, duree) values (2, "AB", "hemogramme AB", 10.0, 21, 2);
insert into typeAnalyse (id, groupeSanguin, hemogramme, prix, vitesseSedimentation, duree) values (3, "O",  "hemogramme O",  10.0, 21, 2);

insert into typeAnalyse (id, groupeSanguin, hemogramme, prix, vitesseSedimentation, duree) values (4, "A",  "hemogramme A 2",  20.0, 42, 1);
insert into typeAnalyse (id, groupeSanguin, hemogramme, prix, vitesseSedimentation, duree) values (5, "B",  "hemogramme B 2",  20.0, 42, 1);
insert into typeAnalyse (id, groupeSanguin, hemogramme, prix, vitesseSedimentation, duree) values (6, "AB", "hemogramme AB 2", 20.0, 42, 1);
insert into typeAnalyse (id, groupeSanguin, hemogramme, prix, vitesseSedimentation, duree) values (7, "O",  "hemogramme O 2",  20.0, 42, 1);
